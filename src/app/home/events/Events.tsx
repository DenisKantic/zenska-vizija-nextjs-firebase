...
const Events = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="lg:text-5xl sm:text-[22px] xs:text-[24px] opacity-80">
          Skorašnji Događaji
        </h1>
      </div>
      <div
        className="flex items-center justify-center text-chineseBlack opacity-80 xs:text-[12px]
      lg:text-xl md:text-[15px] sm:text-[14px] lg:pt-5 lg:pb-4 lg:px-6 lg:my-3 sm:px-9 sm:py-3 xs:px-6 xs:py-4"
      >
      ...
      <div
        className="flex lg:mt-4 flex-wrap lg:justify-end md:justify-center sm:justify-end items-center xs:justify-center 
      mr-4 mb-2 lg:py-4 lg:px-5 sm:pr-2 sm:mt-5 xs:my-4 md:pl-4"
      >
        <span
          className="text-chineseBlack lg:text-xl sm:text-[14px] lg:mr-4 lg:pt-2 lg:pr-4 
        md:mr-2 md:pr-2 md:mb-2 xs:text-[12px] xs:pb-1 xs:px-2"
        >
          Vidi starije događaje
        </span>
        <div
          className="flex flex-wrap lg:space-x-2 xs:space-x-2 sm:space-x-1 md:mb-2
        lg:mr-8 sm:pr-2 sm:pt-1 xs:ml-3"
        >
      ...
      <div
        className="flex lg:flex-row lg:justify-between xs:justify-center xs:flex-col md:justify-center sm:flex-col 
        md:flex-col lg:py-4 xs:px-3 xs:py-3 xs:gap-3 md:gap-2 lg:px-6"
      >
